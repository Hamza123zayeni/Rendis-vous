<?php
// filepath: c:\wamp64\www\RDVFLASH\admin\index.php
// --- AUCUN CARACTERE AVANT CE <?php ---
...
// Valider la session
if (empty($_SESSION['user']) || empty($_SESSION['usertype']) || $_SESSION['usertype'] !== 'a') {
...
$userid = isset($userfetch["aid"]) ? (int)$userfetch["aid"] : 0;
$username = isset($userfetch["aname"]) ? (string)$userfetch["aname"] : '';
